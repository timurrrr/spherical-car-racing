...
def solveGeneric(initial_positions, initial_velocities, calculate_forces_p_v_t, duration, time_step, solver_function, progress_listener_callback_p_v_t):
    ...
    while time < duration:
        if progress_listener_callback_p_v_t:
            ...
            if finished:
                break
        positions, velocities = solver_function(positions, velocities, time, calculate_forces_p_v_t, time_step)
        time = time + time_step
...
def solveRK4(initial_positions, initial_velocities, calculate_forces_p_v_t, duration, time_step, progress_listener_callback_p_v_t = None):
    return solveGeneric(initial_positions, initial_velocities, calculate_forces_p_v_t, duration, time_step, calculateNextStateRK4, progress_listener_callback_p_v_t)
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_stationary_object_no_forces(self):
        # Basic sanity test: a stationary object with no forces applied remains stationary.
        #   x(t) = 42,
        #   v_x(t) = 0.

        positions = [42]
        velocities = [0]
        calculate_forces_p_v_t = lambda p, v, t: [0]

        positions, velocities, time = solveRK4(positions, velocities, calculate_forces_p_v_t, 10, 0.1)
    ...
    def test_moving_object_no_force(self):
        ...
        positions, velocities, time = solveRK4(positions, velocities, calculate_forces_p_v_t, 10, 0.001)
    ...
    def test_stationary_object_constant_force(self):
        ...
        positions = [0]
        velocities = [0]
        calculate_forces_p_v_t = lambda p, v, t: [1]
    ...
    def test_pendulum(self):
        ...
        init_positions = [1]
        init_velocities = [0]
        calculate_forces_p_v_t = lambda p, v, t: [-p[0]]
        ...
        positions, velocities, time = solveRK4(init_positions, init_velocities, calculate_forces_p_v_t, 1.5708, 0.001)
        ...
        positions, velocities, time = solveRK4(init_positions, init_velocities, calculate_forces_p_v_t, 3.1416, 0.001)
        self.assertEqualsApprox(positions[0], -1, 0.0001)
        self.assertEqualsApprox(velocities[0], 0, 0.0005)
        self.assertEqualsApprox(energy(positions, velocities), 0.5, 0.00000001)

        positions, velocities, time = solveRK4(init_positions, init_velocities, calculate_forces_p_v_t, 4.7124, 0.001)
        self.assertEqualsApprox(positions[0], 0, 0.0007)
        self.assertEqualsApprox(velocities[0], 1, 0.0001)
        self.assertEqualsApprox(energy(positions, velocities), 0.5, 0.00000001)

        positions, velocities, time = solveRK4(init_positions, init_velocities, calculate_forces_p_v_t, 6.2832, 0.001)
        self.assertEqualsApprox(positions[0], 1, 0.0001)
        ...
        positions, velocities, time = solveRK4(init_positions, init_velocities, calculate_forces_p_v_t, 314.1593, 0.001)
    ...
    def test_pendulum_2D(self):
        ...
        init_positions = [1, 1]
        init_velocities = [0, 0]
        calculate_forces_p_v_t = lambda p, v, t: [-p[0], -4*p[1]]
        ...
        positions, velocities, time = solveRK4(init_positions, init_velocities, calculate_forces_p_v_t, 0.7854, 0.001)
    ...
    def test_finish(self):
        ...
        positions, velocities, time = solveRK4(positions, velocities, calculate_forces_p_v_t, 100, 0.001, progress_listener_callback_p_v_t)
    ...
    def test_dnf(self):
        ...
        positions, velocities, time = solveRK4(positions, velocities, calculate_forces_p_v_t, 4.2, 0.001, progress_listener_callback_p_v_t)
